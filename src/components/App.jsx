...
import { getFromLocalStorage, initStorage, saveToLocalStorage } from '../data/utils.js';
                ...
                <BrowserRouter>
                    ...
                    <Switch>
                        ...
                        <Route path='/manage' exact>
                            <CardsList data={this.state.data} handleEdit={this.handleCardEdit} handleDelete={this.handleCardDelete} />
                        </Route>
                    </Switch>
                </BrowserRouter>
            </div>
